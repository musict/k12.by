  ...
  <div class="super_container">
    <div class="about-text">
      <div class="col-sm-12">
        <div>
          <br><br><br><br>
          <h1>Маникюр и косметология в Молодечно</h1>
        </div>
        <h5><br>Вне зависимости от возраста каждая из нас <br> хочет выглядеть свежо и очаровательно 👒 </h5>
        <h4><br>Кабинет маникюрных и косметических услуг "<spa class="colorRED">12</spa>" - это место, в котором: <br><br> </h4>
        <ul>
          <h5><li>💥    Ухаживают за лицом, телом, ногтями &#x2702;</li></h5>
        ...
        <ul>
          ...
          <h5>(Читайте об услугах по уходу за лицом <a href="https://k12.by/face.php" target="_blank">здесь</a>)</h5>
          <h5>Кстати! Вот полезная <a href="cosmetology.php">статья</a> о том, как сохранить красоту, здоровье и молодость. </h5>

          <br>
          <h5><li>💥    Оформление бровей и долговременное окрашивание хной (Подробнее <a href="https://k12.by/brows.php" target="_blank">тут</a>)</li></h5>
          <br>
        </ul>
        ...
        <br>
        <h5>В разделе <a href="images/certificate.php" target="_blank">Сертификат 🎁</a> можно узнать о подарочных сертификатах на наши услуги.</h5>
        <h5><br>Ознакомиться с ценами на услуги в <a href="price.php" target="_blank">Прайсе.</a></h5>
        <br>
